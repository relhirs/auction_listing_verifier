...
def page_overview():
    ...
    st.caption(
        "Companion to  — 9 of its 10 analyses are live here "
    ...
    st.markdown(
        ...
        " documents the fix: two separate bugs (a stale "
    ...
    st.markdown(
        ...
        "dashboard — its write-up is kept in  as a historical "
...
def page_calibration():
    ...
    st.caption(
        ...
        "correct? See  section 1 for the full explanation."
    )
    ...
    st.markdown(
        ...
        "See  section 1 for a full worked example (drivetrain)."
    )
...
def page_drivetrain_fix_significance():
    ...
    st.caption(
        ...
        "or could it happen by chance at n=20? See  section 11."
    )
